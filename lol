...
StarterGui:SetCore("SendNotification", {
Title = "❗ ",
Text = "leaked by .gg/sleepyhub if you dont listen to king vyylora you gotta face the
consequences",
Duration = 8, -- seconds the notification stays on screen
Button1 = "Got it"
})
...
assert(type(toEncrypt) == "number" and #{...} == 0, "LPH_ENCNUM only accepts a single
constant double or integer as an argument.")
return toEncrypt
end
LPH_NUMENC = LPH_ENCNUM
LPH_ENCSTR = function(toEncrypt, ...)
assert(type(toEncrypt) == "string" and #{...} == 0, "LPH_ENCSTR only accepts a single
constant string as an argument.")
return toEncrypt
end
LPH_STRENC = LPH_ENCSTR
LPH_ENCFUNC = function(toEncrypt, encKey, decKey, ...)
assert(type(toEncrypt) == "function" and type(encKey) == "string" and #{...} == 0,
"LPH_ENCFUNC accepts a constant function, constant string, and string variable as
arguments.")
return toEncrypt
end
LPH_FUNCENC = LPH_ENCFUNC
LPH_JIT = function(f, ...)
assert(type(f) == "function" and #{...} == 0, "LPH_JIT only accepts a single constant
...
local Game_Name = (game.PlaceId == 4991214437 and "Town") or (game.PlaceId ==
18642421777 and "The Bronx") or (game.PlaceId == 16472538603 and "The Bronx") or
(game.PlaceId == 13643807539 and "South Bronx") or (game.PlaceId == 93612682780562 and
"South Bronx") or (game.PlaceId == 14413475235 and "South Bronx") or (game.PlaceId ==
104715542330896 and "BlockSpin") or (game.PlaceId == 71600459831333 and "Street Life")
or "Universal" or game.PlaceId == 13643807539
...
[1] =
"iFPjbrlufvSzsYurCCdWeFbPeNBWzxywGWLNpzgQVVvkLaoDJjImgWFETWVzc2FnZVR5cGU=
",
[2] =
"AjimhYxuTcBxLtetPTqLQKsdsjDiWNpsPSoXToFfvftufSnLTemZUVKTWVzc2FnZVUlZm8=",
[3] =
"VFevcWxuZHlvFWejJERNXupJDNxvjnIBPHBNZgSMHNOeQURICksIFETWVzc2FnZVR5cGU=
",
[4] =
"RJLHPqjgyYwiGKfgSdISiCpvzGmdJKBkWUMMZHxtipCmivjZdXzDWsTWVzc2FnZUlDHbIdA=
="
}
...
["Drip Store 👓 "] = CFrame.new(67462.6953125, 10489.0322265625,
546.6762084960938);
...
["Gold Shop 🪙 "] = CFrame.new(-78.1158218383789, 2563.1123046875,
944.74365234375);
["Barber 💈 "] = CFrame.new(1217.6531982421875, 2557.93896484375,
981.182861328125);
["Monderella 🍕 "] = CFrame.new(428.89581298828125, 2563.31005859375,
1275.4918212890625);
["Deli 🥪 "] = CFrame.new(-70.2744369506836, 2562.807861328125,
719.9676513671875);
["Library 📖 "] = CFrame.new(53.477169036865234, 2562.908203125,
1960.6444091796875);
["Laboratory 🔬 "] = CFrame.new(564, 2563, 1957);
["Hot Dog Stand 🌭 "] = CFrame.new(295.57403564453125, 2562.7646484375,
1996.2435302734375);
["Gym 💪 " ] = CFrame.new(-37.920719146728516, 2563.05029296875,
442.32647705078125);
["Banks Burgers 🍔 "] = CFrame.new(794.2547607421875, 2562.93701171875,
311.8097229003906);
["Laundromat 💷 "] = CFrame.new(402.6617126464844, 2562.892822265625,
1503.2645263671875);
["Cocaine Factory 🏭 "] = CFrame.new(1227, 2529, 1987);
["Cooking Pots 🧪 "] = CFrame.new(131, 2540, 1004);
["Scrap Metal ⚒ "] = CFrame.new(1049, 2563, 1052);
};
["PackFarm"] = {
["Enabled"] = false;
["AllowedPacks"] = {};
...
local ImageDiddyAhhBlud = game:HttpGet("https://raw.githubusercontent.com/
KingVonOBlockJoyce/imagessynex/main/"..Value)
...
local Repr = loadstring(game:HttpGet("https://raw.githubusercontent.com/Ozzypig/repr/
refs/heads/master/repr.lua"))()
local Required = {
"hookfunction",
"getthreadcontext",
"getconnections",
...
local _getfenv; _getfenv = hookfunction(getrenv().getfenv,
...
local AimbotFieldOfViewOutline = Draw("Circle", {Visible = false, Color = Color3.new(0, 0,
0), Radius = 100, NumSides = 100, Thickness = 4});
local AimbotFieldOfView = Draw("Circle", {Visible = false, Color = Color3.new(1, 1, 1),
Radius = 100, NumSides = 100, Thickness = 2});
local AimbotFieldOfViewFill = Draw("Circle", {Visible = false, Color = Color3.new(1, 1, 1),
Radius = 100, NumSides = 100, Thickness = 2, Filled = true});
local AimbotSnaplineOutline = Draw("Line", {Visible = false, Color = Color3.new(0, 0, 0),
Thickness = 3});
Thickness = 1});
local AimbotSnapline = Draw("Line", {Visible = false, Color = Color3.new(1, 1, 1),
local SilentFieldOfViewOutline = Draw("Circle", {Visible = false, Color = Color3.new(0, 0,
0), Radius = 100, NumSides = 100, Thickness = 4});
local SilentFieldOfView = Draw("Circle", {Visible = false, Color = Color3.new(1, 1, 1),
Radius = 100, NumSides = 100, Thickness = 2});
local SilentFieldOfViewFill = Draw("Circle", {Visible = false, Color = Color3.new(1, 1, 1),
Radius = 100, NumSides = 100, Thickness = 2, Filled = true});
local SilentSnaplineOutline = Draw("Line", {Visible = false, Color = Color3.new(0, 0, 0),
Thickness = 3});
local SilentSnapline = Draw("Line", {Visible = false, Color = Color3.new(1, 1, 1), Thickness
= 1});
...
ProximityPromptService.PromptButtonHoldBegan:Connect(LPH_NO_VIRTUALIZE(function(Pro
mpt, Player)
...
if Bike == nil then
ReplicatedStorage:WaitForChild("RemoteEvents"):WaitForChild("Dealershipinteraction"):FireSer
ver("Spawn", "DirtBike")
...
ReplicatedStorage:WaitForChild("RemoteEvents"):WaitForChild("StorePurchase"):FireServer(Va
lue)
task.wait()
end
end
...
repeat task.wait(2)
ReplicatedStorage:WaitForChild("RemoteEvents"):WaitForChild("StorePurchase"):FireServer("Fl
our")
until LocalPlayer.Backpack:FindFirstChild("Flour")
end
if not LocalPlayer.Backpack:FindFirstChild("Potato") then
repeat task.wait(2)
ReplicatedStorage:WaitForChild("RemoteEvents"):WaitForChild("StorePurchase"):FireServer("P
otato")
...
LocalPlayer.Character:FindFirstChild("Humanoid").Died:Connect(LPH_NO_VIRTUALIZE(functio
n()
...
6696543809,
0,
Vector3.new(0.0070000002160668, 0.0070000002160668,
0.0070000002160668)
},
{
true,
...
if rawget(data, "damage") and type(args[10][1]) == 'number' and
Config.Silent.Enabled and Config.Silent.Targetting and args[10] and data["player"] ==
...
Config.Silent.TargetPart[math.random(1, #Config.Silent.TargetPart)] or "Head"
if SilentTarget and SilentTarget.Character and
SilentTarget.Character:FindFirstChild(RandomPart) then
if not Config.Silent.WallBang then
local Holocaust =
Workspace:FindPartOnRayWithIgnoreList(Ray.new(LocalPlayer.Character[RandomPart].Positio
n, (SilentTarget.Character[RandomPart].Position -
LocalPlayer.Character[RandomPart].Position).Unit *
(SilentTarget.Character[RandomPart].Position -
LocalPlayer.Character[RandomPart].Position).Magnitude), {SilentTarget.Character,
...
Id = "Tahoma.ttf",
Font = game:HttpGet("https://github.com/KingVonOBlockJoyce/OctoHook-UI/raw/refs/
heads/main/fs-tahoma-8px%20(3).ttf"),
})
local Pixel = RegisterFont("Pixel", 400, "Normal", {
Id = "Pixel.ttf",
Font = game:HttpGet("https://github.com/KingVonOBlockJoyce/vaderpaste.luau/raw/refs/
heads/main/Pixel.ttf"),
})
local Minecraftia = RegisterFont("Minecraftia", 400, "Normal", {
Id = "Minecraftia.ttf",
Font = game:HttpGet("https://github.com/i77lhm/storage/raw/refs/heads/main/fonts/
...
Fonts["Minecraftia"] = Font.new(Minecraftia, Enum.FontWeight.Regular,
...
lplayer:IsFriendsWith(plr.UserId) then
...
local tween = tween_service:Create(obj, TweenInfo.new(time or 0.25, easing_style or
Enum.EasingStyle.Quint, Enum.EasingDirection.InOut, 0, false, 0), properties):Play()
return tween
end
...
RAWR)
items[ "UICorenr" ] = library:create( "UICorner" , { -- fire misstypo (im not fixing this
Parent = items[ "colorpicker_holder" ];
Name = "\0";
CornerRadius = dim(0, 4)
});
...
local _request = (http_request and http_request) or (request and request) or (http and
http.request)
section:button({name = "Join Lowest Server", callback = function()
local Servers = string.format("https://games.roblox.com/v1/games/%s/servers/
Public?sortOrder=Asc&limit=100", tostring(game.PlaceId))
...
local Servers = {}
local Request = _request({Url = string.format("https://games.roblox.com/v1/games/
%d/servers/Public?sortOrder=Desc&limit=100&excludeFullGames=true",
...
SafeItemSection = SafeItemColumn:section({name = "Take Selected Item", side =
"right", size = 1, icon = GetImage("UZI.png")})
local _TakeItem = SafeItemSection:list({flag = "TakeSelectedItem_TheBronx", options
= {}, callback = function(state)
task.spawn(LPH_NO_VIRTUALIZE(function()
if not state then
return
...
120, items = {"Default", "Silver", "Gold", "Diamond"}, seperator = false, multi = false, default =
...
local PlayerVisualsSection = VisualsColum:section({name = "Player Visuals", side = "left",
size = 0.725})
...
local PlayerVisualsSettingsSection = VisualsColum:section({name = "Player Visual Settings",
...
local Arguments = {...}
if tostring(self) == "PurchaseItem" and Arguments[2] == 'Shoes' and Arguments[3] == 'YZ
